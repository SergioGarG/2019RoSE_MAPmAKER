...
\begin{abstract}
\claudio{General comment: a paper is not a paper is a piece of art.! Imagine it as a Leopardi Poems, people should enjoy reading your paper.}
...
For these reason, those applications ask for decentralized techniques that allow for tractable automated planning. 
...
\section{The MApMAKER approach}
\label{sec:approach}
\input{Sections/approach.tex}

\section{The MApMAKER tool}
\label{sec:tool}
