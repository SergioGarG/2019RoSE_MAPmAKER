...
A way to increment the efficiency of planning is by using decentralized techniques which generally decompose a complex mission over the team of robots.
...
\item it decomposes the robotic team into subclasses, based on the mission to be achieved; and
\item it is able to work also with only partial knowledge of the environment.
\end{enumerate*}
