...
They usually rely on planners that given a robot or a team of robots computes plans that specify how the robot(s) can fulfill their missions.
...
This paper presents \toolName\ a tool that aims supporting run-time mission execution by tackling the previous challenges, i.e., it provides a decentralized planning solution and  is able to work when only partial knowledge of the environment is present.
...
Partial knowledge is handled by calling two times  a classical planning algorithm.
\end{abstract}
