...
In contrast with current planning techniques used for teams of robots, our proposed solution is decentralized, thus scalable, the considered missions are complex (not traveling from a point A to B) and the knowledge of the environment is partial.
