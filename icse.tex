...
This paper presents \toolName, a tool that aims to support run-time mission execution by tackling the previous challenges, i.e., it provides a decentralized planning solution that helps reducing the planning overhead and  is able to work when only partial knowledge of the environment is present.
