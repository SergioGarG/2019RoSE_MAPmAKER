...
Robot applications are increasingly asking for decentralized techniques that allow for tractable automated planning. %that are \emph{decentralized}, i.e., they decompose the team of robots into classes that have missions that can be analyzed in isolation inside each class.
