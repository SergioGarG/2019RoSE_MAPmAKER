...
The figure shows a screenshot of the MAPmaKER's performance where we changed the size of some numbers, added the plans, and labeled the some cells for helping the reader.
