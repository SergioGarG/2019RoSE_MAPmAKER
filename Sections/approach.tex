...
In the following we provide some additional information about the input processed  by \toolName, the planning algorithm, the selection between definitive and possible plans and how models are updated when information about uncertain parts is detected.
...
\ugh{The planner decomposes the robots within the robotic application} into dependency classes based on the mission that each robot has to achieve.
...
As robots perform actions and navigate within the environment, information regarding uncertain \ugh{actions services} and meeting capabilities can be detected.
...
\toolName\ updates the models of the robots and their environment with the detected information.
