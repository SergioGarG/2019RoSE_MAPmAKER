...
Each robot is able to perform a complex mission, therefore the goals that they reach in the environment represent points where a service is provided \sergio{reference to the other paper containing the running example?}
\claudio{In the intro write. This is a companion presents..
Additional info can be found in~\cite{}. and put the ICSE paper as reference} or where two robots can synchronize.
