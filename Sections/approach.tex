...
If \toolName\ not able to find neither a definitive nor a possible plan a message is sent to the user (\circled{6}).
...
If \toolName\  detects that a plan is not any more executable, the planner is re-executed (\circled{9}).
