...
\textbf{RQ}: {\em Is MAPmAKER able to perform planning in partially known environments?}
...
\toolName\ also improves the performance in terms of plan length in various situations. % since it may consider more planning options.
