...
\claudio{The experiments showed that computing possible plans actually helps mission achievement.}
...
\claudio{We had compared the performance of using \toolName\ with an without enabling the decentralized procedure.
The results show that the decentralized algorithm actually helps in improving performances.}

\claudio{I suggest to remove what follows.}
