...
The computation time and the length of plans are increased whenever \toolName\ a possible plan is chosen but unknown actions, services, and meeting capabilities turned to be not executable, provided, and possible, respectively.
