...
\toolName\ is also effective in the cases in which a possible plan  is computed, it can actually be performed and a classical planning algorithm cannot compute a definitive plan.
...
We then execute \toolName\ with the decentralized procedure enabled and disabled. 
