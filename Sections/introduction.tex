...
However, planning is computationally expensive especially when the number of robots within the team increases and they need to collaborate to fulfill their local missions.
...
The theory that supports \toolName\ including proofs of correctness, a detailed description of the modelling formalisms and the verification procedures can be found in~\cite{mapmaker17}\footnote{This paper is made available for the reviewers   at  \url{https://goo.gl/hrCvyo}}.
