...
\claudio{Introduce the problem first.}
...
\claudio{Not connected with the previous paragraph.}
...
\claudio{At the beginning this is the motivation!}
...
\claudio{You are not introducing robotic applications. You are providing related}
