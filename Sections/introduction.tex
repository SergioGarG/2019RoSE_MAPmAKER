...
\begin{enumerate*}
\item the planning problem should be solved by using algorithms that make the problem tractable; \claudio{To me maybe we can relax the term tractable, because our planner does not make the problem tractable..
		there are planners that work much better than ours. I would say only that work in a decentralized fashion.}
...
\claudio{Yes, I think it is more than sufficient. I am just a bit concern about the term Tractability since Mapmaker does not make the problem tractable.
