...
\begin{document}
	...
	\begin{abstract}
		...
		there are planners that work much better than ours. I would say only that work in a decentralized fashion.}  and possible even when only \emph{partial knowledge} about the robot application is present, e.g., some information about the environment in which the robots are deployed is missing.
